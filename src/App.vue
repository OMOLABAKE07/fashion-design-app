<template>
  <div id="app" class="app-container">
    ...
    <header class="app-header">
      <div class="header-content">
        ...
        <p class="app-subtitle">
          Manage your customers, measurements, designs, and communications all
          in one place.
        </p>
      </div>
    ...
    <div class="main-layout">
      <!-- Sidebar -->
      <nav class="global-navbar" :class="{ open: isSidebarOpen }">
...
.main-layout {
  ...
  min-height: calc(
    100vh - 180px
  ); /* Reduced from 300px to remove extra white space */
}
