      ...
      <div class="header-actions">
        ...
        <div class="filter-controls">
          ...
          <button
            ...
            class="btn-primary filter-create-btn"
          >
            Create Design
          </button>
        </div>
    ...
    <div v-else class="designs-grid">
      ...
      >
        ...
        <div class="design-photo">
          ...
          <div
            class="photo-count"
            v-if="design.photos && design.photos.length > 1"
          >
        ...
        <div class="design-info">
          ...
          <div class="design-details">
            <p class="customer-name">
              ...
              {{ getCustomerName(design.customer_id) }}
            </p>
...
export default {
  ...
  computed: {
    filteredDesigns() {
      ...
      if (this.searchQuery) {
        ...
        filtered = filtered.filter(
          (design) =>
            ...
            this.getCustomerName(design.customer_id)
              .toLowerCase()
              .includes(query) ||
            (design.description &&
      ...
      if (this.statusFilter) {
        filtered = filtered.filter(
          (design) => design.status === this.statusFilter
        );
      }

      if (this.customerFilter) {
        filtered = filtered.filter(
          (design) => design.customer_id === parseInt(this.customerFilter)
        );
      }
  ...
  methods: {
    ...
    getImageUrl(path) {
      ...
      return `http://localhost:3000/storage/${path.replace(
        /^\/?storage\/?/,
        ""
      )}`;
    },
