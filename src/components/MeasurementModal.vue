        ...
        <form @submit.prevent="handleSave">
          ...
          <div class="category-info">
            <p>
              ...
              {{ formatCategories(measurement.categories) }}
            </p>
            <p>
              <strong>Date:</strong>
          ...
          <div class="measurement-fields">
            ...
            <template
              v-for="category in measurement.categories"
              :key="category"
            >
        ...
        if (result.isConfirmed) {
          const updatedMeasurement = {
            ...
            measurements: Object.fromEntries(
              Object.entries(this.editableMeasurement).filter(
                ([key]) => !["notes", "measurementDate"].includes(key)
              )
            ),
    ...
    getFieldsForCategory(category) {
      const fieldDefinitions = {
        male: [
          ...
          {
            key: "agbadaLength",
            label: "Agbada Length (inches)",
            placeholder: "0.00",
          },
          {
            key: "topLength",
            label: "Top Length (inches)",
            placeholder: "0.00",
          },
          {
            key: "kaftanLength",
            label: "Kaftan Length (inches)",
            placeholder: "0.00",
          },
          {
            key: "jalamiaLength",
            label: "Jalamia Length (inches)",
            placeholder: "0.00",
          },
          {
            key: "shirtLength",
          ...
          {
            key: "longSleeve",
            label: "Long Sleeve (inches)",
            placeholder: "0.00",
          },
          {
            key: "shortSleeve",
            label: "Short Sleeve (inches)",
            placeholder: "0.00",
          },
          {
            key: "threeQuarterSleeve",
            label: "3/4 Sleeve (inches)",
            placeholder: "0.00",
          },
          {
            key: "roundSleeve",
            label: "Round Sleeve (inches)",
            placeholder: "0.00",
          },
        ...
        female: [
          ...
          {
            key: "shoulderToUpperBust",
            label: "Shoulder to Upper Bust (inches)",
            placeholder: "0.00",
          },
          {
            key: "shoulderToUnderBust",
            label: "Shoulder to Under Bust (inches)",
            placeholder: "0.00",
          },
          {
            key: "shoulderToNipplePoint",
            label: "Shoulder to Nipple Point (inches)",
            placeholder: "0.00",
          },
          {
            key: "nippleToNipple",
            label: "Nipple to Nipple (inches)",
            placeholder: "0.00",
          },
          {
            key: "roundUpperBust",
            label: "Round Upper Bust (inches)",
            placeholder: "0.00",
          },
          {
            key: "roundUnderBust",
            label: "Round Under Bust (inches)",
            placeholder: "0.00",
          },
          ...
          {
            key: "longSkirt",
            label: "Long Skirt (inches)",
            placeholder: "0.00",
          },
          {
            key: "shortSkirt",
            label: "Short Skirt (inches)",
            placeholder: "0.00",
          },
          {
            key: "threeQuarterSkirt",
            label: "3/4 Skirt (inches)",
            placeholder: "0.00",
          },
          ...
          {
            key: "waistToHipLine",
            label: "Waist to Hip Line (inches)",
            placeholder: "0.00",
          },
          {
            key: "waistToHip",
            label: "Waist to Hip (inches)",
            placeholder: "0.00",
          },
          ...
          {
            key: "longGownLength",
            label: "Long Gown Length (inches)",
            placeholder: "0.00",
          },
          {
            key: "shortGownLength",
            label: "Short Gown Length (inches)",
            placeholder: "0.00",
          },
          {
            key: "threeQuarterGownLength",
            label: "3/4 Gown Length (inches)",
            placeholder: "0.00",
          },
